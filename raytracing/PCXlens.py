...
def PCXlensshape(radius, thickness, diameter):
    ...
    cylinder = CSG.Cylinder(CSG.Vector([0, 0, 0]), CSG.Vector([0, 0, 1]), diameter/2)
    lensshape = CSG.Intersection(lensshape, cylinder)
    return lensshape

EdmundOptics32_477 = PCXlensshape(25.84e-3, 4.90e-3, 25e-3)
